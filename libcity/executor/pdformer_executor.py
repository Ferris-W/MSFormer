...
class PDFormerExecutor(TrafficStateExecutor):
    ...
    def __init__(self, config, model):
        ...
        self.set_loss = config.get('set_loss', 'masked_mae')   # huber
    ...
    def train(self, train_dataloader, eval_dataloader):
        ...
        for epoch_idx in range(self._epoch_num, self.epochs):
            ...
            losses, batches_seen = self._train_epoch(train_dataloader, epoch_idx, batches_seen, self.loss_func)  # loss_func = None
            t1 = time.time()
