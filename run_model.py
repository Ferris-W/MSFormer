...
if __name__ == '__main__':
    ...
    parser.add_argument("--load_ckpt", default=False, type=bool, help='whether load the checkpoint')
    parser.add_argument('--ckpt_epoch', default=0, type=int, help='the epoch of the checkpoint you want to load')
